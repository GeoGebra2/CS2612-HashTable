...
Definition ptr_array_strategy12 :=
  forall (i : Z) (y : Z) (x : Z) (l : (@list Z)) (v : Z) (p : Z),
    ...
    TT &&
    emp **
    ((PtrArray.ceil p x y (@replace_Znth Z (Z.sub i x) v l)))
    ) ** (
    TT &&
    emp -*
    TT &&
