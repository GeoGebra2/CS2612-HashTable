...
Definition check_list_gen_safety_wit_1_low_level_spec := 
...
Definition check_list_gen_safety_wit_2_low_level_spec := 
...
Definition check_list_gen_safety_wit_3_low_level_spec := 
...
Definition check_list_gen_safety_wit_4_low_level_spec := 
...
Definition check_list_gen_entail_wit_1_low_level_spec := 
forall (target_pre: Z) (thm_pre: Z) (X_low_level_spec: ((term * (@list term)) -> (unit -> Prop))) (targ_low_level_spec: term) (theo_low_level_spec: term) ,
  [| (safeExec ATrue (check_rel (theo_low_level_spec) (targ_low_level_spec)) X_low_level_spec ) |]
  &&  (store_term thm_pre theo_low_level_spec )
  **  (store_term target_pre targ_low_level_spec )
...
Definition check_list_gen_entail_wit_2_low_level_spec := 
...
Definition check_list_gen_return_wit_1_low_level_spec := 
...
Definition check_list_gen_return_wit_2_low_level_spec := 
...
Definition check_list_gen_partial_solve_wit_1_low_level_spec := 
...
Definition check_list_gen_partial_solve_wit_2_low_level_spec := 
...
Definition check_list_gen_partial_solve_wit_3_low_level_spec := 
forall (target_pre: Z) (X_low_level_spec: ((term * (@list term)) -> (unit -> Prop))) (targ_low_level_spec: term) (tail_ptr: Z) (thm: Z) (t: term) (l: (@list term)) (retval: Z) (retval_2: Z) ,
  [| (retval = 0) |] 
  &&  [| (retval = (term_alpha_eqn (t) (targ_low_level_spec))) |] 
  &&  [| (safeExec ATrue (check_from_mid_rel (t) (targ_low_level_spec) (l)) X_low_level_spec ) |]
...
Definition check_list_gen_partial_solve_wit_4_low_level_spec := 
...
Definition check_list_gen_partial_solve_wit_5_low_level_spec := 
...
Definition check_list_gen_partial_solve_wit_6_low_level_spec := 
forall (target_pre: Z) (X_low_level_spec: ((term * (@list term)) -> (unit -> Prop))) (targ_low_level_spec: term) (tail_ptr: Z) (t: term) (l: (@list term)) (retval: Z) (retval_2: Z) ,
  [| (retval_2 <> 0) |] 
  &&  [| (retval = 0) |] 
  &&  [| (retval = (term_alpha_eqn (t) (targ_low_level_spec))) |] 
...
Definition check_list_gen_partial_solve_wit_7_low_level_spec_pure := 
...
Definition check_list_gen_partial_solve_wit_7_low_level_spec_aux := 
...
Definition check_list_gen_partial_solve_wit_7_low_level_spec := check_list_gen_partial_solve_wit_7_low_level_spec_pure -> check_list_gen_partial_solve_wit_7_low_level_spec_aux.

Definition check_list_gen_partial_solve_wit_8_low_level_spec_pure := 
...
Definition check_list_gen_partial_solve_wit_8_low_level_spec_aux := 
forall (target_pre: Z) (X_low_level_spec: ((term * (@list term)) -> (unit -> Prop))) (targ_low_level_spec: term) (tail_ptr: Z) (t: term) (l: (@list term)) (retval_2: Z) (retval: Z) (retval_3: Z) (pc: Z) (pa: Z) (c: Z) (r: term) (tr: term) ,
  [| (t = (TermApply ((TermApply ((TermConst (CImpl) (c))) (r))) (tr))) |] 
  &&  [| (retval_3 <> 0) |] 
  &&  [| (retval <> 0) |] 
...
Definition check_list_gen_partial_solve_wit_8_low_level_spec := check_list_gen_partial_solve_wit_8_low_level_spec_pure -> check_list_gen_partial_solve_wit_8_low_level_spec_aux.

Definition check_list_gen_partial_solve_wit_9_low_level_spec := 
...
Definition check_list_gen_partial_solve_wit_10_low_level_spec := 
forall (target_pre: Z) (X_low_level_spec: ((term * (@list term)) -> (unit -> Prop))) (targ_low_level_spec: term) (tail_ptr: Z) (thm: Z) (t: term) (l: (@list term)) (retval: Z) ,
  [| (retval <> 0) |] 
  &&  [| (retval = (term_alpha_eqn (t) (targ_low_level_spec))) |] 
  &&  [| (safeExec ATrue (check_from_mid_rel (t) (targ_low_level_spec) (l)) X_low_level_spec ) |]
...
Definition check_list_gen_partial_solve_wit_11_low_level_spec := 
...
Axiom proof_of_check_list_gen_safety_wit_1_low_level_spec : check_list_gen_safety_wit_1_low_level_spec.
Axiom proof_of_check_list_gen_safety_wit_2_low_level_spec : check_list_gen_safety_wit_2_low_level_spec.
Axiom proof_of_check_list_gen_safety_wit_3_low_level_spec : check_list_gen_safety_wit_3_low_level_spec.
Axiom proof_of_check_list_gen_safety_wit_4_low_level_spec : check_list_gen_safety_wit_4_low_level_spec.
Axiom proof_of_check_list_gen_entail_wit_1_low_level_spec : check_list_gen_entail_wit_1_low_level_spec.
Axiom proof_of_check_list_gen_entail_wit_2_low_level_spec : check_list_gen_entail_wit_2_low_level_spec.
Axiom proof_of_check_list_gen_return_wit_1_low_level_spec : check_list_gen_return_wit_1_low_level_spec.
Axiom proof_of_check_list_gen_return_wit_2_low_level_spec : check_list_gen_return_wit_2_low_level_spec.
Axiom proof_of_check_list_gen_partial_solve_wit_1_low_level_spec : check_list_gen_partial_solve_wit_1_low_level_spec.
Axiom proof_of_check_list_gen_partial_solve_wit_2_low_level_spec : check_list_gen_partial_solve_wit_2_low_level_spec.
Axiom proof_of_check_list_gen_partial_solve_wit_3_low_level_spec : check_list_gen_partial_solve_wit_3_low_level_spec.
Axiom proof_of_check_list_gen_partial_solve_wit_4_low_level_spec : check_list_gen_partial_solve_wit_4_low_level_spec.
Axiom proof_of_check_list_gen_partial_solve_wit_5_low_level_spec : check_list_gen_partial_solve_wit_5_low_level_spec.
Axiom proof_of_check_list_gen_partial_solve_wit_6_low_level_spec : check_list_gen_partial_solve_wit_6_low_level_spec.
Axiom proof_of_check_list_gen_partial_solve_wit_7_low_level_spec_pure : check_list_gen_partial_solve_wit_7_low_level_spec_pure.
Axiom proof_of_check_list_gen_partial_solve_wit_7_low_level_spec : check_list_gen_partial_solve_wit_7_low_level_spec.
Axiom proof_of_check_list_gen_partial_solve_wit_8_low_level_spec_pure : check_list_gen_partial_solve_wit_8_low_level_spec_pure.
Axiom proof_of_check_list_gen_partial_solve_wit_8_low_level_spec : check_list_gen_partial_solve_wit_8_low_level_spec.
Axiom proof_of_check_list_gen_partial_solve_wit_9_low_level_spec : check_list_gen_partial_solve_wit_9_low_level_spec.
Axiom proof_of_check_list_gen_partial_solve_wit_10_low_level_spec : check_list_gen_partial_solve_wit_10_low_level_spec.
Axiom proof_of_check_list_gen_partial_solve_wit_11_low_level_spec : check_list_gen_partial_solve_wit_11_low_level_spec.
