...
Definition LOS_ListDelete_safety_wit_1_low_level_spec := 
...
Definition LOS_ListDelete_safety_wit_2_low_level_spec := 
forall (A: Type) (node_pre: Z) (next_low_level_spec: Z) (prev_low_level_spec: Z) (a_low_level_spec: A) (storeA_low_level_spec: (Z -> (A -> Assertion))) ,
  ((&((prev_low_level_spec)  # "LOS_DL_LIST" ->ₛ "pstNext")) # Ptr  |-> next_low_level_spec)
  **  (dllseg_shift storeA_low_level_spec node_pre node_pre nil )
  **  ((&((node_pre)  # "LOS_DL_LIST" ->ₛ "pstPrev")) # Ptr  |-> prev_low_level_spec)
...
Definition LOS_ListDelete_return_wit_1_low_level_spec := 
forall (A: Type) (node_pre: Z) (next_low_level_spec: Z) (prev_low_level_spec: Z) (a_low_level_spec: A) (storeA_low_level_spec: (Z -> (A -> Assertion))) ,
  ((&((prev_low_level_spec)  # "LOS_DL_LIST" ->ₛ "pstNext")) # Ptr  |-> next_low_level_spec)
  **  (dllseg_shift storeA_low_level_spec node_pre node_pre nil )
...
Definition LOS_ListDelete_partial_solve_wit_1_low_level_spec := 
forall (A: Type) (node_pre: Z) (next_low_level_spec: Z) (prev_low_level_spec: Z) (a_low_level_spec: A) (storeA_low_level_spec: (Z -> (A -> Assertion))) ,
  ((&((node_pre)  # "LOS_DL_LIST" ->ₛ "pstNext")) # Ptr  |-> next_low_level_spec)
...
Definition LOS_ListDelete_partial_solve_wit_2_low_level_spec := 
forall (A: Type) (node_pre: Z) (next_low_level_spec: Z) (prev_low_level_spec: Z) (a_low_level_spec: A) (storeA_low_level_spec: (Z -> (A -> Assertion))) ,
  (dllseg_shift storeA_low_level_spec prev_low_level_spec node_pre (cons ((Build_DL_Node (a_low_level_spec) (node_pre))) (nil)) )
  **  ((&((node_pre)  # "LOS_DL_LIST" ->ₛ "pstNext")) # Ptr  |-> next_low_level_spec)
  **  ((&((next_low_level_spec)  # "LOS_DL_LIST" ->ₛ "pstPrev")) # Ptr  |-> prev_low_level_spec)
...
Definition LOS_ListDelete_partial_solve_wit_3_low_level_spec := 
forall (A: Type) (node_pre: Z) (next_low_level_spec: Z) (prev_low_level_spec: Z) (a_low_level_spec: A) (storeA_low_level_spec: (Z -> (A -> Assertion))) ,
  (dllseg_shift storeA_low_level_spec prev_low_level_spec node_pre (cons ((Build_DL_Node (a_low_level_spec) (node_pre))) (nil)) )
  **  ((&((node_pre)  # "LOS_DL_LIST" ->ₛ "pstNext")) # Ptr  |-> next_low_level_spec)
  **  ((&((next_low_level_spec)  # "LOS_DL_LIST" ->ₛ "pstPrev")) # Ptr  |-> prev_low_level_spec)
...
Axiom proof_of_LOS_ListDelete_safety_wit_1_low_level_spec : LOS_ListDelete_safety_wit_1_low_level_spec.
Axiom proof_of_LOS_ListDelete_safety_wit_2_low_level_spec : LOS_ListDelete_safety_wit_2_low_level_spec.
Axiom proof_of_LOS_ListDelete_return_wit_1_low_level_spec : LOS_ListDelete_return_wit_1_low_level_spec.
Axiom proof_of_LOS_ListDelete_partial_solve_wit_1_low_level_spec : LOS_ListDelete_partial_solve_wit_1_low_level_spec.
Axiom proof_of_LOS_ListDelete_partial_solve_wit_2_low_level_spec : LOS_ListDelete_partial_solve_wit_2_low_level_spec.
Axiom proof_of_LOS_ListDelete_partial_solve_wit_3_low_level_spec : LOS_ListDelete_partial_solve_wit_3_low_level_spec.
