...
Require Import GmpAux GmpNumber.
Import Aux.
...
forall (size_pre: Z) (r_pre: Z) (n_pos: Z) (cap_pos: Z) (old_pos: Z) (ptr_pos: Z) ,
  ...
  **  (UIntArray.undef_ceil ptr_pos old_pos cap_pos )
...
forall (size_pre: Z) (r_pre: Z) (n_neg: Z) (cap_neg: Z) (old_neg: Z) (ptr_neg: Z) ,
  ...
  **  (UIntArray.undef_ceil ptr_neg (-old_neg) cap_neg )
...
Definition mpz_realloc_safety_wit_3_neg := 
...
Definition mpz_realloc_safety_wit_4_pos := 
...
Definition mpz_realloc_safety_wit_5_neg := 
forall (size_pre: Z) (r_pre: Z) (n_neg: Z) (cap_neg: Z) (old_neg: Z) (retval: Z) (retval_2: Z) (retval_3: Z) ,
  ...
  **  (UIntArray.undef_ceil retval_2 (-old_neg) retval )
  **  ((( &( "size" ) )) # Int  |-> retval)
  **  ((( &( "r" ) )) # Ptr  |-> r_pre)
  **  ((&((r_pre)  # "__mpz_struct" ->ₛ "_mp_size")) # Int  |-> old_neg)
  **  ((&((r_pre)  # "__mpz_struct" ->ₛ "_mp_alloc")) # Int  |-> retval)
...
Definition mpz_realloc_safety_wit_6_pos := 
forall (size_pre: Z) (r_pre: Z) (n_pos: Z) (cap_pos: Z) (old_pos: Z) (retval: Z) (retval_2: Z) (retval_3: Z) ,
  ...
  **  (UIntArray.undef_ceil retval_2 old_pos retval )
  **  ((( &( "size" ) )) # Int  |-> retval)
  **  ((( &( "r" ) )) # Ptr  |-> r_pre)
  **  ((&((r_pre)  # "__mpz_struct" ->ₛ "_mp_size")) # Int  |-> old_pos)
  **  ((&((r_pre)  # "__mpz_struct" ->ₛ "_mp_alloc")) # Int  |-> retval)
...
forall (size_pre: Z) (r_pre: Z) (n_pos: Z) (cap_pos: Z) (old_pos: Z) (retval_2: Z) (retval: Z) (retval_3: Z) ,
  ...
  **  (UIntArray.undef_ceil retval old_pos retval_2 )
...
|--
  ...
  &&  (mpd_store_Z_compact UINT_MOD retval n_pos old_pos )
  **  (UIntArray.undef_ceil retval old_pos (Z.max (size_pre) (1)) )
  **  ((&((r_pre)  # "__mpz_struct" ->ₛ "_mp_size")) # Int  |-> old_pos)
...
forall (size_pre: Z) (r_pre: Z) (n_neg: Z) (cap_neg: Z) (old_neg: Z) (retval_2: Z) (retval_3: Z) (retval_4: Z) ,
  [| (retval_4 > retval_2) |] 
  &&  [| (retval_4 = (Zabs (old_neg))) |] 
  &&  [| (cap_neg <> 0) |] 
  &&  [| (retval_2 = (Z.max (size_pre) (1))) |] 
  &&  [| (size_pre >= cap_neg) |] 
  &&  [| (size_pre <= INT_MAX) |] 
  ...
  &&  [| (old_neg < 0) |] 
  &&  [| (n_neg < 0) |]
  &&  (mpd_store_Z_compact UINT_MOD retval_3 (-n_neg) (-old_neg) )
  **  (UIntArray.undef_ceil retval_3 (-old_neg) retval_2 )
  **  ((&((r_pre)  # "__mpz_struct" ->ₛ "_mp_size")) # Int  |-> 0)
  **  ((&((r_pre)  # "__mpz_struct" ->ₛ "_mp_alloc")) # Int  |-> retval_2)
  **  ((&((r_pre)  # "__mpz_struct" ->ₛ "_mp_d")) # Ptr  |-> retval_3)
|--
  EX (r_pre__mp_alloc: Z)  (retval: Z) ,
  [| (n_neg < 0) |] 
  &&  [| (r_pre__mp_alloc = (Z.max (size_pre) (1))) |]
  &&  (mpd_store_Z_compact UINT_MOD retval (-n_neg) (-old_neg) )
  **  (UIntArray.undef_ceil retval (-old_neg) (Z.max (size_pre) (1)) )
  **  ((&((r_pre)  # "__mpz_struct" ->ₛ "_mp_size")) # Int  |-> old_neg)
  **  ((&((r_pre)  # "__mpz_struct" ->ₛ "_mp_alloc")) # Int  |-> r_pre__mp_alloc)
  **  ((&((r_pre)  # "__mpz_struct" ->ₛ "_mp_d")) # Ptr  |-> retval)
.
...
forall (size_pre: Z) (r_pre: Z) (n_neg: Z) (cap_neg: Z) (old_neg: Z) (ptr_neg: Z) (retval_2: Z) (retval_3: Z) (retval_4: Z) ,
  [| (retval_4 > retval_2) |] 
  &&  [| (retval_4 = (Zabs (old_neg))) |] 
  &&  [| (cap_neg = 0) |] 
  &&  [| (retval_2 = (Z.max (size_pre) (1))) |] 
  ...
  &&  [| (old_neg < 0) |] 
  &&  [| (n_neg < 0) |]
  &&  (UIntArray.undef_full retval_3 retval_2 )
  **  (mpd_store_Z_compact UINT_MOD ptr_neg (-n_neg) (-old_neg) )
  **  (UIntArray.undef_ceil ptr_neg (-old_neg) cap_neg )
  **  ((&((r_pre)  # "__mpz_struct" ->ₛ "_mp_size")) # Int  |-> 0)
  **  ((&((r_pre)  # "__mpz_struct" ->ₛ "_mp_alloc")) # Int  |-> retval_2)
...
forall (n_pre: Z) (z_pre: Z) (m_pos: Z) (cap_pos: Z) (old_pos: Z) (r_callee__mp_alloc: Z) (retval: Z) ,
  ...
  **  (UIntArray.undef_ceil retval old_pos (Z.max (n_pre) (1)) )
...
|--
  ...
  &&  (mpd_store_Z_compact UINT_MOD retval m_pos old_pos )
  **  (UIntArray.undef_ceil retval old_pos (Z.max ((Z.max (n_pre) (1))) (cap_pos)) )
  **  ((&((z_pre)  # "__mpz_struct" ->ₛ "_mp_size")) # Int  |-> old_pos)
...
forall (n_pre: Z) (z_pre: Z) (m_neg: Z) (cap_neg: Z) (old_neg: Z) (r_callee__mp_alloc: Z) (retval_2: Z) ,
  [| (m_neg < 0) |] 
  &&  [| (r_callee__mp_alloc = (Z.max (n_pre) (1))) |] 
  &&  [| (n_pre > cap_neg) |] 
  &&  [| (cap_neg >= 0) |] 
  ...
  &&  [| (old_neg < 0) |] 
  &&  [| (m_neg < 0) |]
  &&  (mpd_store_Z_compact UINT_MOD retval_2 (-m_neg) (-old_neg) )
  **  (UIntArray.undef_ceil retval_2 (-old_neg) (Z.max (n_pre) (1)) )
  **  ((&((z_pre)  # "__mpz_struct" ->ₛ "_mp_size")) # Int  |-> old_neg)
  **  ((&((z_pre)  # "__mpz_struct" ->ₛ "_mp_alloc")) # Int  |-> r_callee__mp_alloc)
  **  ((&((z_pre)  # "__mpz_struct" ->ₛ "_mp_d")) # Ptr  |-> retval_2)
|--
  EX (z_pre__mp_alloc: Z)  (retval: Z) ,
  [| (m_neg < 0) |] 
  &&  [| (z_pre__mp_alloc = (Z.max ((Z.max (n_pre) (1))) (cap_neg))) |]
  &&  (mpd_store_Z_compact UINT_MOD retval (-m_neg) (-old_neg) )
  **  (UIntArray.undef_ceil retval (-old_neg) (Z.max ((Z.max (n_pre) (1))) (cap_neg)) )
  **  ((&((z_pre)  # "__mpz_struct" ->ₛ "_mp_size")) # Int  |-> old_neg)
  **  ((&((z_pre)  # "__mpz_struct" ->ₛ "_mp_alloc")) # Int  |-> z_pre__mp_alloc)
  **  ((&((z_pre)  # "__mpz_struct" ->ₛ "_mp_d")) # Ptr  |-> retval)
.

Definition mrz_realloc_if_return_wit_3_pos := 
...
|--
  ...
  &&  [| (z_pre__mp_alloc = (Z.max ((Z.max (n_pre) (1))) (cap_pos))) |]
  &&  (mpd_store_Z_compact UINT_MOD ptr_pos m_pos old_pos )
  **  (UIntArray.undef_ceil ptr_pos old_pos (Z.max ((Z.max (n_pre) (1))) (cap_pos)) )
  **  ((&((z_pre)  # "__mpz_struct" ->ₛ "_mp_size")) # Int  |-> old_pos)
  **  ((&((z_pre)  # "__mpz_struct" ->ₛ "_mp_alloc")) # Int  |-> z_pre__mp_alloc)
  **  ((&((z_pre)  # "__mpz_struct" ->ₛ "_mp_d")) # Ptr  |-> ptr_pos)
.

Definition mrz_realloc_if_return_wit_4_neg := 
...
Axiom proof_of_mpz_realloc_safety_wit_3_neg : mpz_realloc_safety_wit_3_neg.
Axiom proof_of_mpz_realloc_safety_wit_4_pos : mpz_realloc_safety_wit_4_pos.
Axiom proof_of_mpz_realloc_safety_wit_5_neg : mpz_realloc_safety_wit_5_neg.
Axiom proof_of_mpz_realloc_safety_wit_6_pos : mpz_realloc_safety_wit_6_pos.
...
Axiom proof_of_mrz_realloc_if_return_wit_3_pos : mrz_realloc_if_return_wit_3_pos.
Axiom proof_of_mrz_realloc_if_return_wit_4_neg : mrz_realloc_if_return_wit_4_neg.
