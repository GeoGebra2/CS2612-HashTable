...
Lemma proof_of_merge_sort_return_wit_1_low_level_spec : merge_sort_return_wit_1_low_level_spec.
Proof.
  pre_process.
  Exists s1.
...
Lemma proof_of_merge_malloc_return_wit_1 : merge_malloc_return_wit_1.
Proof.
  pre_process.
  sep_apply (sll_zero x). all: try tauto.
  sep_apply sllseg_sll.
...
Lemma proof_of_merge_malloc_return_wit_2 : merge_malloc_return_wit_2.
Proof.
  pre_process.
  sep_apply (sll_zero y). all: try tauto.
  sep_apply sllseg_sll.
