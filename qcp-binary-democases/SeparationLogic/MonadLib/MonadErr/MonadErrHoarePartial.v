...
Proof.
  unfold Hoare_nrm; intros P P' c Q Hpre Hc a σ1 σ2 HP Hrun.
  unfold bind, MonadErr.bind in Hrun; simpl in Hrun.
  unfold nrm_nrm in Hrun.
...
Ltac hoare_nrm_auto :=
  ...
  match goal with
    ...
    | |- Hoare_nrm _ (assert _;; _) _ => apply Hoare_nrm_assert_bind; [auto |intros; try hoare_nrm_auto]
...
Ltac hoare_nrm_auto_s :=
  ...
  match goal with
    ...
    | |- Hoare_nrm _ (assert _;; _) _ => apply Hoare_nrm_assert_bind; [auto | intros; try hoare_nrm_auto_s]
